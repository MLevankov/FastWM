# FastWM
The fast WM for Linux/BSD
This is a experimental project, do not use FastWM as a main WM

cr4at4d by MLevankov

# Install
For install, clone this repository, and install this WM with command: sudo make install
